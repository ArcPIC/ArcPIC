...
potFactor = T_ref   #output units -> Volts
...
for i in xrange(len(stepNum)):
    ...
    potData = datafile['EMFIELD/POTENTIAL']
    rList = potData[:,:,0]*rFactor
    zList = potData[:,:,1]*rFactor
    potList = potData[:,:,2]*potFactor
    datafile.close()
